...
if ($method === "POST") {
    ...
    $sql = "INSERT INTO events (id, name, event_type, loc_name, loc_address, latitude, longitude, instructions, loc_website, date, time, description, image_path, image_alt, price, capacity) 
            VALUES (null, :name, :event_type, :loc_name, :loc_address, :latitude, :longitude, :instructions, :loc_website, :date, :time, :description, :image_path, :image_alt, :price, :capacity)";
